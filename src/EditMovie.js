...
function EditForm({movie}){
  ...
  const editMovie = (values) => {
    fetch(`https://65f16cb4034bdbecc7627ec6.mockapi.io/Movie/${movie.id}`,{
        method: "PUT",
    ...
    return(
        ...
        <h1>Edit Movie</h1>
         <TextField id="outlined-basic" label="Name" variant="outlined" value={formik.values.movie} onChange={formik.handleChange}
